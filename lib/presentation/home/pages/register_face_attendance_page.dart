...
class RegisterFaceAttendanePage extends StatefulWidget {
  const RegisterFaceAttendanePage({super.key});

  @override
  State<RegisterFaceAttendanePage> createState() =>
      _RegisterFaceAttendanePageState();
}

class _RegisterFaceAttendanePageState extends State<RegisterFaceAttendanePage> {
